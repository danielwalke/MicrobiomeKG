    ...
    for label, properties in schema.items():
        ...
        try:
            ...
            if final_state["valid"]:
                ...
                filtered_schema[label] = {"kept_properties": [p for p in properties if p], "removed_properties": []}
        except Exception as e:
            print(f"Error filtering edge properties for {label}: {e}")
            filtered_schema[label] = {"kept_properties": [p for p in properties if p], "removed_properties": []} # keep all on error
