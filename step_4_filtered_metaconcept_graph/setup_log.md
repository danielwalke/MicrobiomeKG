...
1.  **Initialized raw_metagraph directory**: Confirmed location at `/Users/danielwalke/git/microbiomeprocheck/step_4_filtered_metaconceptgraph`.
...
`python -m step_4_filtered_metaconceptgraph.identify_relevant_properties.py`
4. **Filter concept metagraph based on properties**: `python -m step_4_filtered_metaconceptgraph.filter_metagraph.py`
