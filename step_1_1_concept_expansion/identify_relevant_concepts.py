...
with open("config/topic.txt", "r") as f:
    topic = f.read().strip()
...
with open("step_1_1_concept_expansion/concept_labels.json", "r") as f:
...
with open("step_1_1_concept_expansion/relevant_additional_concepts.json", "w") as f:
    json.dump(final_results, f, indent=4)

with open("step_1_1_concept_expansion/removed_additional_concepts.json", "w") as f:
